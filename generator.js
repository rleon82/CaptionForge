 ...
 * Aktywna strategia: 'mock'
 * 
 * Aby podpiąć prawdziwe API (np. OpenAI):
 * 1. Dodaj nową strategię w GeneratorStrategy (np. 'openai')
 * 2. Zmień activeStrategy na 'openai'
 * 3. Reszta kodu nie wymaga zmian
 */
...
const GeneratorStrategy = {
    ...
    /**
     * OPENAI STRATEGY (placeholder – do podpięcia)
     * 
     * Aby aktywować:
     * 1. Odkomentuj ten blok
     * 2. Zmień activeStrategy = 'openai'
     * 3. Dodaj swój klucz API w konfiguracji
     */
    // openai: async function(params) {
    //     const { platform, tone, niche, language, topic } = params;
    //     
    //     const prompt = buildOpenAIPrompt(params);
    //     
    ...
    //     return parseOpenAIResponse(data, params);
    // }
};

// Aktywna strategia – zmień na 'openai' gdy podepniesz API
