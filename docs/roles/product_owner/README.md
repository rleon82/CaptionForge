...
- **Raportowanie postępu** interesariuszom na bazie [`implemented_plans.md`](../../../implemented_plans.md) i [`implemented_features.md`](../../../implemented_features.md).
...
5. **Raport miesięczny** — zsumuj zmiany w [`implemented_features.md`](../../../implemented_features.md) z ostatniego miesiąca; powiąż z metrykami z User Journey Map (sekcja „Metrics to Track").
